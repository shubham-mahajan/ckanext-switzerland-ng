...
def ogdch_add_users_to_groups(context, data_dict={}):
    ...
    If only group_id is given, all non-sysadmin users will be added as
    ...
    if user_id and group_id:
        ...
        return 'Added all non-admin users as members to group "' + group_id + '".'  # noqa
    else:
        members = tk.get_action('user_list')(context, {})
        groups = tk.get_action('group_list')(context, {})
        for member in members:
            # sysadmins will keep their admin role,
            # every other user will be added as a member
